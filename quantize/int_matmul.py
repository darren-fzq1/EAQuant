...
class QuantMatMul(nn.Module):
    def __init__(
        ...
        self.x1_quantizer = UniformAffineQuantizer(**x1_quant_params,rotate=rotate,model_name=model_name+".x1_quantizer")
        self.x2_quantizer = UniformAffineQuantizer(**x2_quant_params,rotate=rotate,model_name=model_name+".x2_quantizer")
